...
const char * Transmogrification::GetSlotName(uint8 slot, WorldSession* session) const
{
    switch (slot)
    {
    case EQUIPMENT_SLOT_HEAD      : return  "Casco";// session->GetTrinityString(LANG_SLOT_NAME_HEAD);
    ...
    case EQUIPMENT_SLOT_WAIST     : return  "Cintur""\xC3\xB3""n";// session->GetTrinityString(LANG_SLOT_NAME_WAIST);
    case EQUIPMENT_SLOT_LEGS      : return  "Pantalones";// session->GetTrinityString(LANG_SLOT_NAME_LEGS);
    case EQUIPMENT_SLOT_FEET      : return  "Botas";// session->GetTrinityString(LANG_SLOT_NAME_FEET);
    case EQUIPMENT_SLOT_WRISTS    : return  "Brazaletes";// session->GetTrinityString(LANG_SLOT_NAME_WRISTS);
    case EQUIPMENT_SLOT_HANDS     : return  "Guantes";// session->GetTrinityString(LANG_SLOT_NAME_HANDS);
    case EQUIPMENT_SLOT_BACK      : return  "Espalda";// session->GetTrinityString(LANG_SLOT_NAME_BACK);
    case EQUIPMENT_SLOT_MAINHAND  : return  "Arma principal";// session->GetTrinityString(LANG_SLOT_NAME_MAINHAND);
    case EQUIPMENT_SLOT_OFFHAND   : return  "Arma secundaria";// session->GetTrinityString(LANG_SLOT_NAME_OFFHAND);
    case EQUIPMENT_SLOT_RANGED    : return  "Arma a distancia";// session->GetTrinityString(LANG_SLOT_NAME_RANGED);
